...
const ProductCard = ({ id_item, nama_item, harga_dasar, total_bidder, tanggal_akhir, tanggal_mulai, kota, gambar_src, gambar_id }) => {
    ...
    return (
        <div className="shadow w-[200px] h-[350px] border relative">
