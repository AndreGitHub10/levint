         ...
         :  */}
            <WhiteCard>
                <div className="flex flex-col">
                    <p className="text-4xl font-bold my-10 text-center mx-auto">Artikel : Barang Antik Jadi Menarik dengan Nilai Sejarahnya</p>
                    <div className=" px-32 h-96 overflow-hidden items-center">
                        <img className=" origin-center" src="https://www.thoughtco.com/thmb/kQwl5vYoYOACYndTydkoTvJecyg=/3865x2576/filters:no_upscale():max_bytes(150000):strip_icc()/antique-irons-170722250-5b3979e046e0fb0037320214.jpg"></img>
                    </div>
